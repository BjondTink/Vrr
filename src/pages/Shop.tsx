...
export default function Shop() {
  ...
  const filteredProducts = filter === "All" ? dbProducts : dbProducts.filter(p => p.category === filter);
    ...
    <div className="pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto">
      <header className="mb-16">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
           ...
           <div className="flex items-center justify-center md:justify-end space-x-6 border-b border-studio-black/5 pb-2">
              <button 
